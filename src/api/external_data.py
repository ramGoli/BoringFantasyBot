    ...
    def _get_player_props(self) -> List[Dict[str, Any]]:
        ...
        try:
            ...
            for event in events_data:  # Check all events to find the right games
                ...
                # Previously we filtered events by a short list of teams to reduce API calls.
                # This caused missing props when players' teams were not in that list.
                # Fetch props for all events to ensure complete coverage.
